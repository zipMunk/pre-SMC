...
) ENGINE = MyISAM AUTO_INCREMENT = 76 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of chat_message
-- ----------------------------
INSERT INTO `chat_message` VALUES (1, 0, '0', '0');
INSERT INTO `chat_message` VALUES (2, 4, 'user', '医生你好，我头痛得厉害。病人的以往病史是：病史{      病史Id：\'10\';    病人的询问的问题是：\'你好，大夫，我头痛。\';    用户年龄：\'23\';    用户性别：\'男\';    用户身高和体重：\'177cm,60kg\';    症状：\'头痛恶心持续三天。\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'两天发作一次，一次发作一小时\';    生活方式因素，包括饮食、运动、睡眠等：\'饮食正常，睡眠不足\';    病史：\'一个月前感冒发烧\';    过敏药物：\'无过敏药物\';    正在服用的药物：\'目前正在使用三九感冒灵\';    记录时间：\'Fri Jun 21 11:37:04 CST 2024;    诊断结果：\'根据你的描述，你可能正在经历偏头痛或者由于睡眠不足引起的紧张性头痛。考虑到你之前有感冒发烧的经历，也可能是病毒感染后的后遗症。但是，由于你提到头痛恶心持续三天且频率较高，我建议你尽快去医院就诊，以便进行详细的身体检查，排除其他可能的疾病，如颅内压增高等。同时，保持良好的生活习惯，保证充足的睡眠，避免过度劳累。如果你的症状加重或出现新的症状，如视力模糊、语言不清等，应立即就医。在没有医生指导的情况下，不建议随意更改或停止目前的感冒药物使用。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (3, 4, 'assistant', '根据您提供的信息，您的头痛可能与偏头痛有关，也可能与睡眠不足引起的紧张性头痛有关。此外，考虑到您一个月前曾有过感冒发烧的经历，这也可能是病毒感染后的后遗症。\n\n然而，由于您的头痛已经持续了三天，并且频率较高，我强烈建议您尽快去医院就诊，以便进行详细的身体检查，以排除其他可能的疾病，如颅内压增高等。在医院，医生可能会进行一些测试，如血液测试、影像学检查（如CT扫描或MRI）等，以确定头痛的原因。\n\n在此期间，您可以尝试以下方法来缓解头痛：\n\n1. 保持良好的生活习惯：确保每天有足够的睡眠，避免过度劳累。\n2. 饮食健康：避免过于油腻、辛辣的食物，多吃新鲜蔬菜和水果。\n3. 适当的运动：适度的运动可以帮助减轻压力，改善血液循环，从而有助于缓解头痛。\n4. 放松技巧：学习并实践放松技巧，如深呼吸、瑜伽或冥想，可以帮助减轻压力，减少头痛的发生。\n\n请记住，以上建议不能替代专业医疗意见。如果您的头痛持续不减或者症状加重，请立即就医。');
INSERT INTO `chat_message` VALUES (4, 8, 'user', '大夫，我胃痛得厉害，我该吃哪些药？病人的以往病史是：病史{      病史Id：\'14\';    病人的询问的问题是：\'大夫您好，我胃痛得厉害。\';    用户年龄：\'25\';    用户性别：\'男\';    用户身高和体重：\'165，60kg\';    症状：\'胃痛，上吐下泻\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'每天中午饭后发作\';    生活方式因素，包括饮食、运动、睡眠等：\'饮食，吃的有点多，喝酒\';    病史：\'没患过什么病\';    过敏药物：\'无\';    正在服用的药物：\'正在使用蒙脱石散\';    记录时间：\'Mon Jun 24 00:53:48 CST 2024;    诊断结果：\'考虑到您的胃痛症状在每天中午饭后发作，可能与饮食过多和饮酒有关，这可能是急性胃炎或者消化不良的表现。蒙脱石散可以帮助缓解腹泻，但对于胃痛可能效果有限。建议您：\n\n1. 尽量避免油腻、辛辣食物，以及过量饮酒，保持清淡饮食。\n2. 分餐制，每餐少吃，避免一次性吃太多。\n3. 饮食规律，避免空腹进食，尤其是刺激性食物。\n4. 可以尝试服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用。\n5. 如果症状持续不减或者加重，建议及时就诊，可能需要进一步检查，比如胃镜，以便了解具体病因。\n\n同时，由于您没有特殊的疾病史，这次的胃痛可能是暂时性的，但如果频繁发作或症状严重，还是需要关注。请记住，以上建议仅供参考，具体治疗还需根据您的实际情况由医生决定。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (5, 8, 'assistant', '建议尽量避免油腻、辛辣食物，以及过量饮酒，保持清淡饮食；分餐制，每餐少吃，避免一次性吃太多；饮食规律，避免空腹进食，尤其是刺激性食物；可以尝试服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用；如果症状持续不减或者加重，建议及时就诊，可能需要进一步检查，比如胃镜，以便了解具体病因。');
INSERT INTO `chat_message` VALUES (6, 4, 'user', '医生你好，我头痛得厉害。病人的以往病史是：病史{      病史Id：\'10\';    病人的询问的问题是：\'你好，大夫，我头痛。\';    用户年龄：\'23\';    用户性别：\'男\';    用户身高和体重：\'177cm,60kg\';    症状：\'头痛恶心持续三天。\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'两天发作一次，一次发作一小时\';    生活方式因素，包括饮食、运动、睡眠等：\'饮食正常，睡眠不足\';    病史：\'一个月前感冒发烧\';    过敏药物：\'无过敏药物\';    正在服用的药物：\'目前正在使用三九感冒灵\';    记录时间：\'Fri Jun 21 11:37:04 CST 2024;    诊断结果：\'根据你的描述，你可能正在经历偏头痛或者由于睡眠不足引起的紧张性头痛。考虑到你之前有感冒发烧的经历，也可能是病毒感染后的后遗症。但是，由于你提到头痛恶心持续三天且频率较高，我建议你尽快去医院就诊，以便进行详细的身体检查，排除其他可能的疾病，如颅内压增高等。同时，保持良好的生活习惯，保证充足的睡眠，避免过度劳累。如果你的症状加重或出现新的症状，如视力模糊、语言不清等，应立即就医。在没有医生指导的情况下，不建议随意更改或停止目前的感冒药物使用。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (7, 4, 'assistant', '根据您提供的信息，您的头痛可能与偏头痛有关，也可能与睡眠不足引起的紧张性头痛有关。此外，考虑到您一个月前曾有过感冒发烧的经历，这也可能是病毒感染后的后遗症。\n\n然而，由于您的头痛已经持续了三天，并且频率较高，我强烈建议您尽快去医院就诊，以便进行详细的身体检查，以排除其他可能的疾病，如颅内压增高等。在医院，医生可能会进行一些测试，如血液测试、影像学检查（如CT扫描或MRI）等，以确定头痛的原因。\n\n在此期间，您可以尝试以下方法来缓解头痛：\n\n1. 保持良好的生活习惯：确保每天有足够的睡眠，避免过度劳累。\n2. 饮食健康：避免过于油腻、辛辣的食物，多吃新鲜蔬菜和水果。\n3. 适当的运动：适度的运动可以帮助减轻压力，改善血液循环，从而有助于缓解头痛。\n4. 放松技巧：学习并实践放松技巧，如深呼吸、瑜伽或冥想，可以帮助减轻压力，减少头痛的发生。\n\n请记住，以上建议不能替代专业医疗意见。如果您的头痛持续不减或者症状加重，请立即就医。');
INSERT INTO `chat_message` VALUES (8, 4, 'user', '你好我头痛得厉害，我该吃什么药？病人的以往病史是：病史{      病史Id：\'10\';    病人的询问的问题是：\'你好，大夫，我头痛。\';    用户年龄：\'23\';    用户性别：\'男\';    用户身高和体重：\'177cm,60kg\';    症状：\'头痛恶心持续三天。\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'两天发作一次，一次发作一小时\';    生活方式因素，包括饮食、运动、睡眠等：\'饮食正常，睡眠不足\';    病史：\'一个月前感冒发烧\';    过敏药物：\'无过敏药物\';    正在服用的药物：\'目前正在使用三九感冒灵\';    记录时间：\'Fri Jun 21 11:37:04 CST 2024;    诊断结果：\'根据你的描述，你可能正在经历偏头痛或者由于睡眠不足引起的紧张性头痛。考虑到你之前有感冒发烧的经历，也可能是病毒感染后的后遗症。但是，由于你提到头痛恶心持续三天且频率较高，我建议你尽快去医院就诊，以便进行详细的身体检查，排除其他可能的疾病，如颅内压增高等。同时，保持良好的生活习惯，保证充足的睡眠，避免过度劳累。如果你的症状加重或出现新的症状，如视力模糊、语言不清等，应立即就医。在没有医生指导的情况下，不建议随意更改或停止目前的感冒药物使用。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (9, 4, 'assistant', '首先，我要强调的是，任何药物的使用都应在医生的指导下进行。如果您正在考虑使用非处方药来缓解头痛，那么我建议您先咨询医生的意见。\n\n对于偏头痛，常用的药物包括阿司匹林、布洛芬、萘普生等非甾体抗炎药（NSAIDs），以及曲普坦类药物（如罗拉特、普瑞巴林等）。这些药物可以有效地缓解偏头痛的疼痛和恶心等症状。\n\n对于紧张性头痛，通常使用的药物包括非处方药的对乙酰氨基酚（例如泰诺）和处方药的三环抗抑郁药（例如阿米替林）。这些药物可以帮助缓解头痛和焦虑症状。\n\n然而，这些药物都有可能产生副作用，因此在使用任何药物之前，都应该先咨询医生的意见。此外，长期大量使用某些药物可能会导致依赖性和耐受性，所以应该尽量避免长期使用。\n\n最后，我想再次强调，如果您的头痛持续不减或者症状加重，请立即就医。在没有医生指导的情况下，不建议随意更改或停止目前的感冒药物使用。');
INSERT INTO `chat_message` VALUES (10, 4, 'user', '医生你好，我头痛得厉害。病人的以往病史是：病史{      病史Id：\'10\';    病人的询问的问题是：\'你好，大夫，我头痛。\';    用户年龄：\'23\';    用户性别：\'男\';    用户身高和体重：\'177cm,60kg\';    症状：\'头痛恶心持续三天。\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'两天发作一次，一次发作一小时\';    生活方式因素，包括饮食、运动、睡眠等：\'饮食正常，睡眠不足\';    病史：\'一个月前感冒发烧\';    过敏药物：\'无过敏药物\';    正在服用的药物：\'目前正在使用三九感冒灵\';    记录时间：\'Fri Jun 21 11:37:04 CST 2024;    诊断结果：\'根据你的描述，你可能正在经历偏头痛或者由于睡眠不足引起的紧张性头痛。考虑到你之前有感冒发烧的经历，也可能是病毒感染后的后遗症。但是，由于你提到头痛恶心持续三天且频率较高，我建议你尽快去医院就诊，以便进行详细的身体检查，排除其他可能的疾病，如颅内压增高等。同时，保持良好的生活习惯，保证充足的睡眠，避免过度劳累。如果你的症状加重或出现新的症状，如视力模糊、语言不清等，应立即就医。在没有医生指导的情况下，不建议随意更改或停止目前的感冒药物使用。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (11, 4, 'assistant', '根据您提供的信息，您的头痛可能与偏头痛有关，也可能与睡眠不足引起的紧张性头痛有关。此外，考虑到您一个月前曾有过感冒发烧的经历，这也可能是病毒感染后的后遗症。\n\n然而，由于您的头痛已经持续了三天，并且频率较高，我强烈建议您尽快去医院就诊，以便进行详细的身体检查，以排除其他可能的疾病，如颅内压增高等。在医院，医生可能会进行一些测试，如血液测试、影像学检查（如CT扫描或MRI）等，以确定头痛的原因。\n\n在此期间，您可以尝试以下方法来缓解头痛：\n\n1. 保持良好的生活习惯：确保每天有足够的睡眠，避免过度劳累。\n2. 饮食健康：避免过于油腻、辛辣的食物，多吃新鲜蔬菜和水果。\n3. 适当的运动：适度的运动可以帮助减轻压力，改善血液循环，从而有助于缓解头痛。\n4. 放松技巧：学习并实践放松技巧，如深呼吸、瑜伽或冥想，可以帮助减轻压力，减少头痛的发生。\n\n请记住，以上建议不能替代专业医疗意见。如果您的头痛持续不减或者症状加重，请立即就医。');
INSERT INTO `chat_message` VALUES (12, 4, 'user', '你好我头痛得厉害，我该吃什么药？病人的以往病史是：病史{      病史Id：\'10\';    病人的询问的问题是：\'你好，大夫，我头痛。\';    用户年龄：\'23\';    用户性别：\'男\';    用户身高和体重：\'177cm,60kg\';    症状：\'头痛恶心持续三天。\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'两天发作一次，一次发作一小时\';    生活方式因素，包括饮食、运动、睡眠等：\'饮食正常，睡眠不足\';    病史：\'一个月前感冒发烧\';    过敏药物：\'无过敏药物\';    正在服用的药物：\'目前正在使用三九感冒灵\';    记录时间：\'Fri Jun 21 11:37:04 CST 2024;    诊断结果：\'根据你的描述，你可能正在经历偏头痛或者由于睡眠不足引起的紧张性头痛。考虑到你之前有感冒发烧的经历，也可能是病毒感染后的后遗症。但是，由于你提到头痛恶心持续三天且频率较高，我建议你尽快去医院就诊，以便进行详细的身体检查，排除其他可能的疾病，如颅内压增高等。同时，保持良好的生活习惯，保证充足的睡眠，避免过度劳累。如果你的症状加重或出现新的症状，如视力模糊、语言不清等，应立即就医。在没有医生指导的情况下，不建议随意更改或停止目前的感冒药物使用。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (13, 4, 'assistant', '首先，我要强调的是，任何药物的使用都应在医生的指导下进行。如果您正在考虑使用非处方药来缓解头痛，那么我建议您先咨询医生的意见。\n\n对于偏头痛，常用的药物包括阿司匹林、布洛芬、萘普生等非甾体抗炎药（NSAIDs），以及曲普坦类药物（如罗拉特、普瑞巴林等）。这些药物可以有效地缓解偏头痛的疼痛和恶心等症状。\n\n对于紧张性头痛，通常使用的药物包括非处方药的对乙酰氨基酚（例如泰诺）和处方药的三环抗抑郁药（例如阿米替林）。这些药物可以帮助缓解头痛和焦虑症状。\n\n然而，这些药物都有可能产生副作用，因此在使用任何药物之前，都应该先咨询医生的意见。此外，长期大量使用某些药物可能会导致依赖性和耐受性，所以应该尽量避免长期使用。\n\n最后，我想再次强调，如果您的头痛持续不减或者症状加重，请立即就医。在没有医生指导的情况下，不建议随意更改或停止目前的感冒药物使用。');
INSERT INTO `chat_message` VALUES (14, 4, 'user', '你好，我胃痛得厉害，请结合我的病历给出作答。');
INSERT INTO `chat_message` VALUES (15, 4, 'assistant', '您好，关于您的胃痛问题，需要更多的病情信息才能做出准确的诊断和治疗建议。以下是一些可能有助于您了解自己病情的信息：\n\n- 您是否感到胃部不适或疼痛？\n- 您是否有消化不良、恶心、呕吐、腹泻等症状？\n- 您是否经常感到饱胀感或上腹部不适？\n- 您是否有食欲不振、口干舌燥、便秘或腹泻等症状？\n- 您是否有过胃溃疡、胃炎、胃癌等疾病的历史？\n\n请您提供更多的病情信息，以便我可以更好地帮助您。');
INSERT INTO `chat_message` VALUES (16, 8, 'user', '大夫，我胃痛得厉害，我该吃哪些药？病人的以往病史是：病史{      病史Id：\'14\';    病人的询问的问题是：\'大夫您好，我胃痛得厉害。\';    用户年龄：\'25\';    用户性别：\'男\';    用户身高和体重：\'165，60kg\';    症状：\'胃痛，上吐下泻\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'每天中午饭后发作\';    生活方式因素，包括饮食、运动、睡眠等：\'饮食，吃的有点多，喝酒\';    病史：\'没患过什么病\';    过敏药物：\'无\';    正在服用的药物：\'正在使用蒙脱石散\';    记录时间：\'Mon Jun 24 00:53:48 CST 2024;    诊断结果：\'考虑到您的胃痛症状在每天中午饭后发作，可能与饮食过多和饮酒有关，这可能是急性胃炎或者消化不良的表现。蒙脱石散可以帮助缓解腹泻，但对于胃痛可能效果有限。建议您：\n\n1. 尽量避免油腻、辛辣食物，以及过量饮酒，保持清淡饮食。\n2. 分餐制，每餐少吃，避免一次性吃太多。\n3. 饮食规律，避免空腹进食，尤其是刺激性食物。\n4. 可以尝试服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用。\n5. 如果症状持续不减或者加重，建议及时就诊，可能需要进一步检查，比如胃镜，以便了解具体病因。\n\n同时，由于您没有特殊的疾病史，这次的胃痛可能是暂时性的，但如果频繁发作或症状严重，还是需要关注。请记住，以上建议仅供参考，具体治疗还需根据您的实际情况由医生决定。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (17, 8, 'assistant', '建议尽量避免油腻、辛辣食物，以及过量饮酒，保持清淡饮食；分餐制，每餐少吃，避免一次性吃太多；饮食规律，避免空腹进食，尤其是刺激性食物；可以尝试服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用；如果症状持续不减或者加重，建议及时就诊，可能需要进一步检查，比如胃镜，以便了解具体病因。');
INSERT INTO `chat_message` VALUES (18, 8, 'user', '医生你好，我胃痛得厉害病人的以往病史是：病史{      病史Id：\'15\';    病人的询问的问题是：\'你好医生，我胃痛得厉害\';    用户年龄：\'25\';    用户性别：\'男\';    用户身高和体重：\'176，60kg\';    症状：\'我现在胃痛得厉害\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'两天发作一次\';    生活方式因素，包括饮食、运动、睡眠等：\'都正常\';    病史：\'没有\';    过敏药物：\'没有过敏症状\';    正在服用的药物：\'没有\';    记录时间：\'Mon Jun 24 10:27:55 CST 2024;    诊断结果：\'对于您的胃痛，可能是由于饮食不当、压力过大或者消化系统的一些常见问题引起的。如果您的疼痛非常剧烈，或者有持续性、烧心、呕吐、黑便等症状，建议您立即就医，因为这可能提示更严重的问题，如胃溃疡或胃炎。同时，保持良好的饮食习惯，避免辛辣、油腻食物，多喝水，定时定量进食，尽量减少压力，也有助于缓解胃痛。但鉴于您没有过敏史和正在使用的药物，短期内可以先尝试这些自我照顾措施。如果疼痛持续，最好去医院就诊，让专业医生进行评估。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (19, 8, 'user', '医生你好，我胃痛得厉害');
INSERT INTO `chat_message` VALUES (20, 8, 'assistant', '建议您注意饮食卫生，避免食用生冷食物和过于油腻的食物，多吃蔬菜水果，保持大便通畅。此外，建议您避免过度劳累和精神紧张，保证充足的睡眠时间。如果疼痛持续或加重，请及时就医。');
INSERT INTO `chat_message` VALUES (21, 8, 'user', '大夫，我胃痛得厉害，我该吃哪些药？病人的以往病史是：病史{      病史Id：\'14\';    病人的询问的问题是：\'大夫您好，我胃痛得厉害。\';    用户年龄：\'25\';    用户性别：\'男\';    用户身高和体重：\'165，60kg\';    症状：\'胃痛，上吐下泻\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'每天中午饭后发作\';    生活方式因素，包括饮食、运动、睡眠等：\'饮食，吃的有点多，喝酒\';    病史：\'没患过什么病\';    过敏药物：\'无\';    正在服用的药物：\'正在使用蒙脱石散\';    记录时间：\'Mon Jun 24 00:53:48 CST 2024;    诊断结果：\'考虑到您的胃痛症状在每天中午饭后发作，可能与饮食过多和饮酒有关，这可能是急性胃炎或者消化不良的表现。蒙脱石散可以帮助缓解腹泻，但对于胃痛可能效果有限。建议您：\n\n1. 尽量避免油腻、辛辣食物，以及过量饮酒，保持清淡饮食。\n2. 分餐制，每餐少吃，避免一次性吃太多。\n3. 饮食规律，避免空腹进食，尤其是刺激性食物。\n4. 可以尝试服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用。\n5. 如果症状持续不减或者加重，建议及时就诊，可能需要进一步检查，比如胃镜，以便了解具体病因。\n\n同时，由于您没有特殊的疾病史，这次的胃痛可能是暂时性的，但如果频繁发作或症状严重，还是需要关注。请记住，以上建议仅供参考，具体治疗还需根据您的实际情况由医生决定。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (22, 8, 'assistant', '建议尽量避免油腻、辛辣食物，以及过量饮酒，保持清淡饮食；分餐制，每餐少吃，避免一次性吃太多；饮食规律，避免空腹进食，尤其是刺激性食物；可以尝试服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用；如果症状持续不减或者加重，建议及时就诊，可能需要进一步检查，比如胃镜，以便了解具体病因。');
INSERT INTO `chat_message` VALUES (23, 8, 'user', '医生你好，我胃痛得厉害病人的以往病史是：病史{      病史Id：\'15\';    病人的询问的问题是：\'你好医生，我胃痛得厉害\';    用户年龄：\'25\';    用户性别：\'男\';    用户身高和体重：\'176，60kg\';    症状：\'我现在胃痛得厉害\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'两天发作一次\';    生活方式因素，包括饮食、运动、睡眠等：\'都正常\';    病史：\'没有\';    过敏药物：\'没有过敏症状\';    正在服用的药物：\'没有\';    记录时间：\'Mon Jun 24 10:27:55 CST 2024;    诊断结果：\'对于您的胃痛，可能是由于饮食不当、压力过大或者消化系统的一些常见问题引起的。如果您的疼痛非常剧烈，或者有持续性、烧心、呕吐、黑便等症状，建议您立即就医，因为这可能提示更严重的问题，如胃溃疡或胃炎。同时，保持良好的饮食习惯，避免辛辣、油腻食物，多喝水，定时定量进食，尽量减少压力，也有助于缓解胃痛。但鉴于您没有过敏史和正在使用的药物，短期内可以先尝试这些自我照顾措施。如果疼痛持续，最好去医院就诊，让专业医生进行评估。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (24, 8, 'user', '医生你好，我胃痛得厉害');
INSERT INTO `chat_message` VALUES (25, 8, 'assistant', '建议您注意饮食卫生，避免食用生冷食物和过于油腻的食物，多吃蔬菜水果，保持大便通畅。此外，建议您避免过度劳累和精神紧张，保证充足的睡眠时间。如果疼痛持续或加重，请及时就医。');
INSERT INTO `chat_message` VALUES (26, 8, 'user', '我该吃哪些非处方药，具体的用法用量呢？');
INSERT INTO `chat_message` VALUES (27, 8, 'assistant', '建议您先尝试一些非处方药来缓解症状，例如阿司匹林、布洛芬等解热镇痛药，但请注意不要长期大量使用。另外，您可以考虑服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用。如果您有任何不适或疑问，请及时咨询医生。');
INSERT INTO `chat_message` VALUES (28, 8, 'user', '大夫，我胃痛得厉害，我该吃哪些药？病人的以往病史是：病史{      病史Id：\'14\';    病人的询问的问题是：\'大夫您好，我胃痛得厉害。\';    用户年龄：\'25\';    用户性别：\'男\';    用户身高和体重：\'165，60kg\';    症状：\'胃痛，上吐下泻\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'每天中午饭后发作\';    生活方式因素，包括饮食、运动、睡眠等：\'饮食，吃的有点多，喝酒\';    病史：\'没患过什么病\';    过敏药物：\'无\';    正在服用的药物：\'正在使用蒙脱石散\';    记录时间：\'Mon Jun 24 00:53:48 CST 2024;    诊断结果：\'考虑到您的胃痛症状在每天中午饭后发作，可能与饮食过多和饮酒有关，这可能是急性胃炎或者消化不良的表现。蒙脱石散可以帮助缓解腹泻，但对于胃痛可能效果有限。建议您：\n\n1. 尽量避免油腻、辛辣食物，以及过量饮酒，保持清淡饮食。\n2. 分餐制，每餐少吃，避免一次性吃太多。\n3. 饮食规律，避免空腹进食，尤其是刺激性食物。\n4. 可以尝试服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用。\n5. 如果症状持续不减或者加重，建议及时就诊，可能需要进一步检查，比如胃镜，以便了解具体病因。\n\n同时，由于您没有特殊的疾病史，这次的胃痛可能是暂时性的，但如果频繁发作或症状严重，还是需要关注。请记住，以上建议仅供参考，具体治疗还需根据您的实际情况由医生决定。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (29, 8, 'assistant', '建议尽量避免油腻、辛辣食物，以及过量饮酒，保持清淡饮食；分餐制，每餐少吃，避免一次性吃太多；饮食规律，避免空腹进食，尤其是刺激性食物；可以尝试服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用；如果症状持续不减或者加重，建议及时就诊，可能需要进一步检查，比如胃镜，以便了解具体病因。');
INSERT INTO `chat_message` VALUES (30, 8, 'user', '医生你好，我胃痛得厉害病人的以往病史是：病史{      病史Id：\'15\';    病人的询问的问题是：\'你好医生，我胃痛得厉害\';    用户年龄：\'25\';    用户性别：\'男\';    用户身高和体重：\'176，60kg\';    症状：\'我现在胃痛得厉害\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'两天发作一次\';    生活方式因素，包括饮食、运动、睡眠等：\'都正常\';    病史：\'没有\';    过敏药物：\'没有过敏症状\';    正在服用的药物：\'没有\';    记录时间：\'Mon Jun 24 10:27:55 CST 2024;    诊断结果：\'对于您的胃痛，可能是由于饮食不当、压力过大或者消化系统的一些常见问题引起的。如果您的疼痛非常剧烈，或者有持续性、烧心、呕吐、黑便等症状，建议您立即就医，因为这可能提示更严重的问题，如胃溃疡或胃炎。同时，保持良好的饮食习惯，避免辛辣、油腻食物，多喝水，定时定量进食，尽量减少压力，也有助于缓解胃痛。但鉴于您没有过敏史和正在使用的药物，短期内可以先尝试这些自我照顾措施。如果疼痛持续，最好去医院就诊，让专业医生进行评估。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (31, 8, 'user', '医生你好，我胃痛得厉害');
INSERT INTO `chat_message` VALUES (32, 8, 'assistant', '建议您注意饮食卫生，避免食用生冷食物和过于油腻的食物，多吃蔬菜水果，保持大便通畅。此外，建议您避免过度劳累和精神紧张，保证充足的睡眠时间。如果疼痛持续或加重，请及时就医。');
INSERT INTO `chat_message` VALUES (33, 8, 'user', '我该吃哪些非处方药，具体的用法用量呢？');
INSERT INTO `chat_message` VALUES (34, 8, 'assistant', '建议您先尝试一些非处方药来缓解症状，例如阿司匹林、布洛芬等解热镇痛药，但请注意不要长期大量使用。另外，您可以考虑服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用。如果您有任何不适或疑问，请及时咨询医生。');
INSERT INTO `chat_message` VALUES (35, 8, 'user', '我该去什么类型的医院\n');
INSERT INTO `chat_message` VALUES (36, 8, 'assistant', '建议您前往综合医院或胃肠科专科医院就诊，由专业的医生进行评估并制定个性化的治疗方案。如果您有医保卡，也可以选择医保定点医院就诊。');
INSERT INTO `chat_message` VALUES (37, 4, 'user', '大夫，我胃痛得厉害，我该吃哪些药？病人的以往病史是：病史{      病史Id：\'14\';    病人的询问的问题是：\'大夫您好，我胃痛得厉害。\';    用户年龄：\'25\';    用户性别：\'男\';    用户身高和体重：\'165，60kg\';    症状：\'胃痛，上吐下泻\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'每天中午饭后发作\';    生活方式因素，包括饮食、运动、睡眠等：\'饮食，吃的有点多，喝酒\';    病史：\'没患过什么病\';    过敏药物：\'无\';    正在服用的药物：\'正在使用蒙脱石散\';    记录时间：\'Mon Jun 24 00:53:48 CST 2024;    诊断结果：\'考虑到您的胃痛症状在每天中午饭后发作，可能与饮食过多和饮酒有关，这可能是急性胃炎或者消化不良的表现。蒙脱石散可以帮助缓解腹泻，但对于胃痛可能效果有限。建议您：\n\n1. 尽量避免油腻、辛辣食物，以及过量饮酒，保持清淡饮食。\n2. 分餐制，每餐少吃，避免一次性吃太多。\n3. 饮食规律，避免空腹进食，尤其是刺激性食物。\n4. 可以尝试服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用。\n5. 如果症状持续不减或者加重，建议及时就诊，可能需要进一步检查，比如胃镜，以便了解具体病因。\n\n同时，由于您没有特殊的疾病史，这次的胃痛可能是暂时性的，但如果频繁发作或症状严重，还是需要关注。请记住，以上建议仅供参考，具体治疗还需根据您的实际情况由医生决定。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (38, 4, 'assistant', '建议尽量避免油腻、辛辣食物，以及过量饮酒，保持清淡饮食；分餐制，每餐少吃，避免一次性吃太多；饮食规律，避免空腹进食，尤其是刺激性食物；可以尝试服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用；如果症状持续不减或者加重，建议及时就诊，可能需要进一步检查，比如胃镜，以便了解具体病因。');
INSERT INTO `chat_message` VALUES (39, 4, 'user', '医生你好，我胃痛得厉害病人的以往病史是：病史{      病史Id：\'15\';    病人的询问的问题是：\'你好医生，我胃痛得厉害\';    用户年龄：\'25\';    用户性别：\'男\';    用户身高和体重：\'176，60kg\';    症状：\'我现在胃痛得厉害\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'两天发作一次\';    生活方式因素，包括饮食、运动、睡眠等：\'都正常\';    病史：\'没有\';    过敏药物：\'没有过敏症状\';    正在服用的药物：\'没有\';    记录时间：\'Mon Jun 24 10:27:55 CST 2024;    诊断结果：\'对于您的胃痛，可能是由于饮食不当、压力过大或者消化系统的一些常见问题引起的。如果您的疼痛非常剧烈，或者有持续性、烧心、呕吐、黑便等症状，建议您立即就医，因为这可能提示更严重的问题，如胃溃疡或胃炎。同时，保持良好的饮食习惯，避免辛辣、油腻食物，多喝水，定时定量进食，尽量减少压力，也有助于缓解胃痛。但鉴于您没有过敏史和正在使用的药物，短期内可以先尝试这些自我照顾措施。如果疼痛持续，最好去医院就诊，让专业医生进行评估。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (40, 4, 'user', '医生你好，我胃痛得厉害');
INSERT INTO `chat_message` VALUES (41, 4, 'assistant', '建议您注意饮食卫生，避免食用生冷食物和过于油腻的食物，多吃蔬菜水果，保持大便通畅。此外，建议您避免过度劳累和精神紧张，保证充足的睡眠时间。如果疼痛持续或加重，请及时就医。');
INSERT INTO `chat_message` VALUES (42, 4, 'user', '我该吃哪些非处方药，具体的用法用量呢？');
INSERT INTO `chat_message` VALUES (43, 4, 'assistant', '建议您先尝试一些非处方药来缓解症状，例如阿司匹林、布洛芬等解热镇痛药，但请注意不要长期大量使用。另外，您可以考虑服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用。如果您有任何不适或疑问，请及时咨询医生。');
INSERT INTO `chat_message` VALUES (44, 4, 'user', '我该去什么类型的医院\n');
INSERT INTO `chat_message` VALUES (45, 4, 'assistant', '建议您前往综合医院或胃肠科专科医院就诊，由专业的医生进行评估并制定个性化的治疗方案。如果您有医保卡，也可以选择医保定点医院就诊。');
INSERT INTO `chat_message` VALUES (46, 4, 'user', '医生，我头痛得厉害');
INSERT INTO `chat_message` VALUES (47, 4, 'assistant', '建议您先尝试一些非处方药来缓解头痛，例如对乙酰氨基酚（泰诺）等。如果头痛持续或加重，请及时就医。');
INSERT INTO `chat_message` VALUES (48, 4, 'user', '大夫，我胃痛得厉害，我该吃哪些药？病人的以往病史是：病史{      病史Id：\'14\';    病人的询问的问题是：\'大夫您好，我胃痛得厉害。\';    用户年龄：\'25\';    用户性别：\'男\';    用户身高和体重：\'165，60kg\';    症状：\'胃痛，上吐下泻\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'每天中午饭后发作\';    生活方式因素，包括饮食、运动、睡眠等：\'饮食，吃的有点多，喝酒\';    病史：\'没患过什么病\';    过敏药物：\'无\';    正在服用的药物：\'正在使用蒙脱石散\';    记录时间：\'Mon Jun 24 00:53:48 CST 2024;    诊断结果：\'考虑到您的胃痛症状在每天中午饭后发作，可能与饮食过多和饮酒有关，这可能是急性胃炎或者消化不良的表现。蒙脱石散可以帮助缓解腹泻，但对于胃痛可能效果有限。建议您：\n\n1. 尽量避免油腻、辛辣食物，以及过量饮酒，保持清淡饮食。\n2. 分餐制，每餐少吃，避免一次性吃太多。\n3. 饮食规律，避免空腹进食，尤其是刺激性食物。\n4. 可以尝试服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用。\n5. 如果症状持续不减或者加重，建议及时就诊，可能需要进一步检查，比如胃镜，以便了解具体病因。\n\n同时，由于您没有特殊的疾病史，这次的胃痛可能是暂时性的，但如果频繁发作或症状严重，还是需要关注。请记住，以上建议仅供参考，具体治疗还需根据您的实际情况由医生决定。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (49, 4, 'assistant', '建议尽量避免油腻、辛辣食物，以及过量饮酒，保持清淡饮食；分餐制，每餐少吃，避免一次性吃太多；饮食规律，避免空腹进食，尤其是刺激性食物；可以尝试服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用；如果症状持续不减或者加重，建议及时就诊，可能需要进一步检查，比如胃镜，以便了解具体病因。');
INSERT INTO `chat_message` VALUES (50, 4, 'user', '医生你好，我胃痛得厉害病人的以往病史是：病史{      病史Id：\'15\';    病人的询问的问题是：\'你好医生，我胃痛得厉害\';    用户年龄：\'25\';    用户性别：\'男\';    用户身高和体重：\'176，60kg\';    症状：\'我现在胃痛得厉害\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'两天发作一次\';    生活方式因素，包括饮食、运动、睡眠等：\'都正常\';    病史：\'没有\';    过敏药物：\'没有过敏症状\';    正在服用的药物：\'没有\';    记录时间：\'Mon Jun 24 10:27:55 CST 2024;    诊断结果：\'对于您的胃痛，可能是由于饮食不当、压力过大或者消化系统的一些常见问题引起的。如果您的疼痛非常剧烈，或者有持续性、烧心、呕吐、黑便等症状，建议您立即就医，因为这可能提示更严重的问题，如胃溃疡或胃炎。同时，保持良好的饮食习惯，避免辛辣、油腻食物，多喝水，定时定量进食，尽量减少压力，也有助于缓解胃痛。但鉴于您没有过敏史和正在使用的药物，短期内可以先尝试这些自我照顾措施。如果疼痛持续，最好去医院就诊，让专业医生进行评估。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (51, 4, 'user', '医生你好，我胃痛得厉害');
INSERT INTO `chat_message` VALUES (52, 4, 'assistant', '建议您注意饮食卫生，避免食用生冷食物和过于油腻的食物，多吃蔬菜水果，保持大便通畅。此外，建议您避免过度劳累和精神紧张，保证充足的睡眠时间。如果疼痛持续或加重，请及时就医。');
INSERT INTO `chat_message` VALUES (53, 4, 'user', '我该吃哪些非处方药，具体的用法用量呢？');
INSERT INTO `chat_message` VALUES (54, 4, 'assistant', '建议您先尝试一些非处方药来缓解症状，例如阿司匹林、布洛芬等解热镇痛药，但请注意不要长期大量使用。另外，您可以考虑服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用。如果您有任何不适或疑问，请及时咨询医生。');
INSERT INTO `chat_message` VALUES (55, 4, 'user', '我该去什么类型的医院\n');
INSERT INTO `chat_message` VALUES (56, 4, 'assistant', '建议您前往综合医院或胃肠科专科医院就诊，由专业的医生进行评估并制定个性化的治疗方案。如果您有医保卡，也可以选择医保定点医院就诊。');
INSERT INTO `chat_message` VALUES (57, 4, 'user', '医生，我头痛得厉害');
INSERT INTO `chat_message` VALUES (58, 4, 'assistant', '建议您先尝试一些非处方药来缓解头痛，例如对乙酰氨基酚（泰诺）等。如果头痛持续或加重，请及时就医。');
INSERT INTO `chat_message` VALUES (59, 4, 'user', '请详细说一下，我正在使用泰诺了，我现在每天头痛得睡不着');
INSERT INTO `chat_message` VALUES (60, 4, 'assistant', '如果您的头痛非常剧烈，影响到睡眠，建议您尽快就医，以免病情加重。在等待就医的过程中，您可以尝试以下方法来缓解头痛：1. 休息，放松身体和大脑；2. 暂停使用其他药物，如咖啡因或其他刺激性物质；3. 喝足够的水，保持水分平衡；4. 使用冷敷或热敷来缓解头痛。但是，如果头痛持续或加重，还是建议您尽快就医。');
INSERT INTO `chat_message` VALUES (61, 4, 'user', '大夫，我胃痛得厉害，我该吃哪些药？病人的以往病史是：病史{      病史Id：\'14\';    病人的询问的问题是：\'大夫您好，我胃痛得厉害。\';    用户年龄：\'25\';    用户性别：\'男\';    用户身高和体重：\'165，60kg\';    症状：\'胃痛，上吐下泻\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'每天中午饭后发作\';    生活方式因素，包括饮食、运动、睡眠等：\'饮食，吃的有点多，喝酒\';    病史：\'没患过什么病\';    过敏药物：\'无\';    正在服用的药物：\'正在使用蒙脱石散\';    记录时间：\'Mon Jun 24 00:53:48 CST 2024;    诊断结果：\'考虑到您的胃痛症状在每天中午饭后发作，可能与饮食过多和饮酒有关，这可能是急性胃炎或者消化不良的表现。蒙脱石散可以帮助缓解腹泻，但对于胃痛可能效果有限。建议您：\n\n1. 尽量避免油腻、辛辣食物，以及过量饮酒，保持清淡饮食。\n2. 分餐制，每餐少吃，避免一次性吃太多。\n3. 饮食规律，避免空腹进食，尤其是刺激性食物。\n4. 可以尝试服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用。\n5. 如果症状持续不减或者加重，建议及时就诊，可能需要进一步检查，比如胃镜，以便了解具体病因。\n\n同时，由于您没有特殊的疾病史，这次的胃痛可能是暂时性的，但如果频繁发作或症状严重，还是需要关注。请记住，以上建议仅供参考，具体治疗还需根据您的实际情况由医生决定。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (62, 4, 'assistant', '建议尽量避免油腻、辛辣食物，以及过量饮酒，保持清淡饮食；分餐制，每餐少吃，避免一次性吃太多；饮食规律，避免空腹进食，尤其是刺激性食物；可以尝试服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用；如果症状持续不减或者加重，建议及时就诊，可能需要进一步检查，比如胃镜，以便了解具体病因。');
INSERT INTO `chat_message` VALUES (63, 4, 'user', '医生你好，我胃痛得厉害病人的以往病史是：病史{      病史Id：\'15\';    病人的询问的问题是：\'你好医生，我胃痛得厉害\';    用户年龄：\'25\';    用户性别：\'男\';    用户身高和体重：\'176，60kg\';    症状：\'我现在胃痛得厉害\';    病情发作相关细节，如发作时间，持续时间，发作频率：\'两天发作一次\';    生活方式因素，包括饮食、运动、睡眠等：\'都正常\';    病史：\'没有\';    过敏药物：\'没有过敏症状\';    正在服用的药物：\'没有\';    记录时间：\'Mon Jun 24 10:27:55 CST 2024;    诊断结果：\'对于您的胃痛，可能是由于饮食不当、压力过大或者消化系统的一些常见问题引起的。如果您的疼痛非常剧烈，或者有持续性、烧心、呕吐、黑便等症状，建议您立即就医，因为这可能提示更严重的问题，如胃溃疡或胃炎。同时，保持良好的饮食习惯，避免辛辣、油腻食物，多喝水，定时定量进食，尽量减少压力，也有助于缓解胃痛。但鉴于您没有过敏史和正在使用的药物，短期内可以先尝试这些自我照顾措施。如果疼痛持续，最好去医院就诊，让专业医生进行评估。\';       }请你结合这些信息给出相应的建议');
INSERT INTO `chat_message` VALUES (64, 4, 'user', '医生你好，我胃痛得厉害');
INSERT INTO `chat_message` VALUES (65, 4, 'assistant', '建议您注意饮食卫生，避免食用生冷食物和过于油腻的食物，多吃蔬菜水果，保持大便通畅。此外，建议您避免过度劳累和精神紧张，保证充足的睡眠时间。如果疼痛持续或加重，请及时就医。');
INSERT INTO `chat_message` VALUES (66, 4, 'user', '我该吃哪些非处方药，具体的用法用量呢？');
INSERT INTO `chat_message` VALUES (67, 4, 'assistant', '建议您先尝试一些非处方药来缓解症状，例如阿司匹林、布洛芬等解热镇痛药，但请注意不要长期大量使用。另外，您可以考虑服用一些抗酸药物，如铝碳酸镁片，但最好在医生指导下使用。如果您有任何不适或疑问，请及时咨询医生。');
INSERT INTO `chat_message` VALUES (68, 4, 'user', '我该去什么类型的医院\n');
INSERT INTO `chat_message` VALUES (69, 4, 'assistant', '建议您前往综合医院或胃肠科专科医院就诊，由专业的医生进行评估并制定个性化的治疗方案。如果您有医保卡，也可以选择医保定点医院就诊。');
INSERT INTO `chat_message` VALUES (70, 4, 'user', '医生，我头痛得厉害');
INSERT INTO `chat_message` VALUES (71, 4, 'assistant', '建议您先尝试一些非处方药来缓解头痛，例如对乙酰氨基酚（泰诺）等。如果头痛持续或加重，请及时就医。');
INSERT INTO `chat_message` VALUES (72, 4, 'user', '请详细说一下，我正在使用泰诺了，我现在每天头痛得睡不着');
INSERT INTO `chat_message` VALUES (73, 4, 'assistant', '如果您的头痛非常剧烈，影响到睡眠，建议您尽快就医，以免病情加重。在等待就医的过程中，您可以尝试以下方法来缓解头痛：1. 休息，放松身体和大脑；2. 暂停使用其他药物，如咖啡因或其他刺激性物质；3. 喝足够的水，保持水分平衡；4. 使用冷敷或热敷来缓解头痛。但是，如果头痛持续或加重，还是建议您尽快就医。');
INSERT INTO `chat_message` VALUES (74, 4, 'user', '医生，我现在感冒，使用三九感冒灵外，还要使用什么药品？');
INSERT INTO `chat_message` VALUES (75, 4, 'assistant', '感冒通常是由病毒引起的，因此抗生素并不能治疗感冒。建议您继续使用三九感冒灵等药物来缓解症状，并注意休息，多喝水，适当补充维生素C等营养素。如果症状持续或加重，请及时就医。');
...
INSERT INTO `feedback` VALUES (9, '王五', '2222222222@qq.com', '反馈！', '系统很好用，就是加载有点慢！', '2024-06-24 00:59:10', '2024-06-24 00:59:10');
...
INSERT INTO `history` VALUES (164, 8, '湿疹', 2, '2024-06-24 00:56:41', '2024-06-24 00:56:41');
INSERT INTO `history` VALUES (165, 8, '湿疹', 2, '2024-06-24 00:56:53', '2024-06-24 00:56:53');
INSERT INTO `history` VALUES (166, 8, '7,无', 1, '2024-06-24 00:58:19', '2024-06-24 00:58:19');
INSERT INTO `history` VALUES (167, 8, '湿疹', 2, '2024-06-24 00:58:20', '2024-06-24 00:58:20');
INSERT INTO `history` VALUES (168, 4, '湿疹', 2, '2024-06-24 10:41:02', '2024-06-24 10:41:02');
INSERT INTO `history` VALUES (169, 4, '湿疹', 2, '2024-06-24 10:42:05', '2024-06-24 10:42:05');
...
INSERT INTO `pageview` VALUES (6, 11, 13);
...
INSERT INTO `patient_history` VALUES (15, 8, '你好医生，我胃痛得厉害', 25, '男', '176，60kg', '我现在胃痛得厉害', '两天发作一次', '都正常', '没有', '没有过敏症状', '没有', '2024-06-24 10:27:55', '对于您的胃痛，可能是由于饮食不当、压力过大或者消化系统的一些常见问题引起的。如果您的疼痛非常剧烈，或者有持续性、烧心、呕吐、黑便等症状，建议您立即就医，因为这可能提示更严重的问题，如胃溃疡或胃炎。同时，保持良好的饮食习惯，避免辛辣、油腻食物，多喝水，定时定量进食，尽量减少压力，也有助于缓解胃痛。但鉴于您没有过敏史和正在使用的药物，短期内可以先尝试这些自我照顾措施。如果疼痛持续，最好去医院就诊，让专业医生进行评估。');
INSERT INTO `patient_history` VALUES (16, 4, '我头痛得厉害', 23, '男', '177cm，60kg', '我很头痛，每晚都睡不着', '每晚发作一次', '饮食正常，熬夜', '最近没患病', '不过敏', '没使用', '2024-06-24 10:39:19', '考虑到您的过往病史，特别是一个月前的感冒发烧和头痛恶心的情况，您的当前头痛可能与之前的疾病有关，比如可能是偏头痛或因睡眠不足引起的紧张性头痛。由于您现在每晚都有头痛并且影响睡眠，这表明头痛可能已经成为了慢性问题。\n\n首先，保持规律的生活习惯非常重要，尽量避免熬夜，保证充足的睡眠。饮食上也要注意营养均衡，避免过度疲劳和压力。您可以试试热敷额头或颈部，以及做一些轻度的放松活动，如深呼吸或瑜伽，帮助缓解头痛。\n\n然而，由于您的头痛持续时间较长且频繁，建议您再次就医，尤其是如果头痛加重或伴随其他症状（如视觉变化、恶心、呕吐）。医生可能会建议做进一步的检查，如头部CT或MRI，以排除其他潜在病因，如颅内压增高。\n\n虽然您之前对感冒药物没有过敏反应，但在没有医生指导下，不建议自行调整或停止使用任何药物，包括三九感冒灵。请咨询医生关于是否需要调整剂量或更换其他治疗方案。\n\n总之，及时就医并告知医生您的病史和当前状况，有助于得到最合适的治疗建议。');
...
INSERT INTO `user` VALUES (8, 'test', '王五', '123456', 25, '男', '2272069656@qq.com', '22222222222', 1, NULL, '2024-06-24 00:51:55', '2024-06-24 00:51:55');
